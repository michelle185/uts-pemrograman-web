					...
					<div class="cart-table-wrap">
						<table class="cart-table">
							...
							<tbody>
								...
								<tr class="table-body-row">
									<td class="product-remove"><a href="#"><i class="far fa-window-close"></i></a></td>
									<td class="product-image"><img src="<?= base_url('assets/img/products/product-img-2.jpg')?>" alt=""></td>
								...
								<tr class="table-body-row">
									<td class="product-remove"><a href="#"><i class="far fa-window-close"></i></a></td>
									<td class="product-image"><img src="<?= base_url('assets/img/products/product-img-3.jpg')?>" alt=""></td>
				...
				<div class="col-lg-4">
					<div class="total-section">
						...
						<div class="cart-buttons">
							<a href="<?= base_url('shop/cart')?>" class="boxed-btn">Update Cart</a>
							<a href="<?= base_url('shop/check_out')?>" class="boxed-btn black">Check Out</a>
						</div>
					</div>
